...
| `0x07` | [GetReadoutState](./GetReadoutState.md#request)                       | Request to get readout state.                                                  |
...
| `0x13` | [GetLorawanInfo](./GetLorawanInfo.md#request)                         | Request to get LoRaWAN information.                                            |
| `0x15` | [GetLorawanState](./GetLorawanState.md#request)                       | Request to get LoRaWAN state.                                                  |
| `0x17` | [SetLorawanActivationMethod](./SetLorawanActivationMethod.md#request) | Request to set the LoRaWAN activation method OTAA or ABP.                      |
| `0x19` | [Reboot](./Reboot.md#request)                                         | Request to reboot the observer device.                                         |
...
| `0x42` | [SetObisId](./SetObisId.md#request)                                   | Request to set the id for the specific OBIS code.                              |
...
| `0x08` | [GetReadoutState](./GetReadoutState.md#response)                              | Response to the [GetReadoutState](./GetReadoutState.md#request) downlink command.                       |
...
| `0x43` | [SetObisId](./SetObisId.md#response)                                          | Response to the [SetObisId](./SetObisId.md#request) downlink command.                                   |
| `0x45` | [AddObisProfile](./AddObisProfile.md#response)                                | Response to the [AddObisProfile](./AddObisProfile.md#request) downlink command.                         |
| `0x47` | [RemoveObisProfile](./RemoveObisProfile.md#response)                          | Response to the [RemoveObisProfile](./RemoveObisProfile.md#request) downlink command.                   |
| `0x49` | [GetObisProfile](./GetObisProfile.md#response)                                | Response to the [GetObisProfile](./GetObisProfile.md#request) downlink command.                         |
| `0x4b` | [GetObisInfo](./GetObisInfo.md#response)                                      | Response to the [GetObisInfo](./GetObisInfo.md#request) downlink command.                               |
| `0x4d` | [GetObisContent](./GetObisContent.md#response)                                | Response to the [GetObisContent](./GetObisContent.md#request) downlink command.                         |
| `0x4f` | [GetObisContentById](./GetObisContentById.md#response-with-float-content)     | Response to the [GetObisContentById](./GetObisContentById.md#request) downlink command.                 |
| `0x50` | [GetObisContentByIdStr](./GetObisContentById.md#response-with-string-content) | Response to the [GetObisContentByIdStr](./GetObisContentByIdStr.md#request) downlink command.           |
| `0x51` | [ObservationReport](./uplink/ObservationReport.md)                            | Content of the OBIS codes that were captured with float content.                                        |
| `0x52` | [ObservationReportString](./uplink/ObservationReportString.md)                | Content of the OBIS codes that were captured with string content.                                       |
